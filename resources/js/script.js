$(document).ready(function() {
    ...
    $('.js--wp-app').waypoint(function(direction){
        $('.js--wp-app').addClass('animated fadeInLeft');
    }, {
        offset:'50%'
    });
    ...
    $('.js--wp-signup').waypoint(function(direction){
        $('.js--wp-signup').addClass('animated pulse');
    }, {
        offset:'50%'
    });
